...
tape('headers', function(t) {
    ...
    t.deepEqual({'Content-Type':'application/x-protobuf'}, tiletype.headers('pbf'));
    t.deepEqual({'Content-Type':'application/x-protobuf','Content-Encoding':'deflate'}, tiletype.headers('deflate'));
    t.deepEqual({'Content-Type':'application/x-protobuf','Content-Encoding':'gzip'}, tiletype.headers('gzip'));
